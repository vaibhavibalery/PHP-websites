...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/crud/index.php">About</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/crud/index.php">Contact Us</a>
        </li>
  ...
  <div class="container my-3">
    ...
    <form action="/crud/index.php" method="POST">
      <div class="form-group">
        <label for="title" style="color: lightsalmon; font-size:20px;">Note Title</label>
        <input type="text" class="form-control" id="title" name="title" aria-describedby="titleHelp">
      </div>

      <div class="form-group">
        <label for="desc" style="color: lightsalmon; font-size:20px;">Note Description</label>
